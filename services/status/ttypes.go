...
func (p TStatusCode) String() string {
	switch p {
	case TStatusCode_OK:
		return "TStatusCode_OK"
	case TStatusCode_CANCELLED:
		return "TStatusCode_CANCELLED"
	case TStatusCode_ANALYSIS_ERROR:
		return "TStatusCode_ANALYSIS_ERROR"
	case TStatusCode_NOT_IMPLEMENTED_ERROR:
		return "TStatusCode_NOT_IMPLEMENTED_ERROR"
	case TStatusCode_RUNTIME_ERROR:
		return "TStatusCode_RUNTIME_ERROR"
	case TStatusCode_MEM_LIMIT_EXCEEDED:
		return "TStatusCode_MEM_LIMIT_EXCEEDED"
	case TStatusCode_INTERNAL_ERROR:
		return "TStatusCode_INTERNAL_ERROR"
	}
	return "<UNSET>"
}
...
func (p *TStatus) writeField2(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("error_msgs", thrift.LIST, 2); err != nil {
		return fmt.Errorf("%T write field begin error 2:error_msgs: %s", p, err)
	}
	...
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 2:error_msgs: %s", p, err)
	}
	return err
}
