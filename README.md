...
**The legacy Beeswax protocol based driver is available at [go-impala v1.0.0](https://github.com/jrbrinlee1/go-impala/tree/v1.0.0), which is marked deprecated and will no longer be maintained.**

*If you are using Go 1.12 or later, you can get the v1.0.0 of the driver with ***go get github.com/jrbrinlee1/go-impala@v1.0.0*** or use a dependency management tool such as [dep](https://golang.github.io/dep/])*
